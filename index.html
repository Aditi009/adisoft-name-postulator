...
<script src="https://stackpath.bootstrapcdn.com/bootstrap/4.5.2/js/bootstrap.min.js" integrity="sha384-B4gt1jrGC7Jh4AgTPSdUtOBvfO8shuf57BaghqFfPlYxofvL8/KUEfYiJOMMV+rV" crossorigin="anonymous"></script>
	...
	<body >
       ...
       <div  id="mob-v" >
        ...
        <div class="container mt-5">
            ...
            <img src="jobclues.png" class="inp-img" style="float: left">
            ...
            <div id="outout">
                <div id="inout">
                   ...
                   <img src="img%20(2).png" id="in-img">
                    <p class="np">Name Postulator</p>
                    <div id="out"></div>
  ...
  <div class="card-body">
    ...
    <a class="btn">Next Game</a>
       ...
       <div class="card ml-5 mt-5" style="width: 18rem;">
  <img src="images%20(1).jpg" class="card-img-top" alt="...">
  <div class="card-body">
    <p class="card-text">A game is a structured form of play, usually undertaken for entertainment or fun, and sometimes used as an educational tool. Games are distinct from work</p>
    <a class="btn">Next Game</a>
  </div>
  ...
  <div class="card-body">
    ...
    <a class="btn">Next Game</a>
            ...
            <div class="cpd"><br>SUNIL KUMAR YADAV &copy; 2020-21</div>
